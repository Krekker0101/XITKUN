...
Abdulloh Ashurov Assistant supports two update channels:
...
# - Tag: v2.0.8-beta.1
# - Title: Abdulloh Ashurov Assistant v2.0.8-beta.1
# - Mark as "Pre-release"
# - Upload files from release/:
#   - Abdulloh Ashurov Assistant Setup 2.0.8-beta.1.exe
#   - Abdulloh Ashurov Assistant.2.0.8-beta.1.exe
...
# 3. Upload to GitHub Release
# - Tag: v2.0.8
# - Title: Abdulloh Ashurov Assistant v2.0.8
# - Upload files from release/:
#   - Abdulloh Ashurov Assistant Setup 2.0.8.exe
#   - Abdulloh Ashurov Assistant.2.0.8.exe
