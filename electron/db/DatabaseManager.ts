...
${ELECTRON_BRAND.appName} is a real-time AI meeting assistant designed to help you stay focused, informed, and fast-moving during calls. Get live insights while you speak, instant answers to questions, and structured notes after every meeting.
...
- Show or hide ${ELECTRON_BRAND.shortAppName} at any time:
  - **Mac**: Cmd + B
  - **Windows**: Ctrl + B
...
- **Usage**: Track your interaction history and see how ${ELECTRON_BRAND.shortAppName} assisted you.
...
# Making the Most of ${ELECTRON_BRAND.shortAppName}
...
### Undetectability
Unlock the **Undetectability** add-on to keep ${ELECTRON_BRAND.shortAppName} invisible during screen sharing.
...
**Once downloaded, return to Settings → Credentials in ${ELECTRON_BRAND.shortAppName} and select this file to complete setup.**
...
If you need help with setup or usage, update the support details in the branding config before distribution.`;

        const demoMeeting: Meeting = {
            id: demoId,
            title: `${ELECTRON_BRAND.appName} Demo & Guide`,
            date: today.toISOString(),
            duration: "5:00",
            summary: `Complete guide to using ${ELECTRON_BRAND.appName} - your real-time AI meeting assistant.`,
            detailedSummary: {
            ...
            transcript: [
                { speaker: 'interviewer', text: `Welcome to ${ELECTRON_BRAND.appName}! Let me show you how it works.`, timestamp: 0 },
                ...
                { speaker: 'user', text: `How do I hide ${ELECTRON_BRAND.shortAppName} during screen share?`, timestamp: 60000 },
                { speaker: 'interviewer', text: "Press Cmd+B to toggle visibility anytime. You can also enable protected overlay mode in settings.", timestamp: 65000 },
            ...
            usage: [
                { type: 'assist', timestamp: 15000, question: `What features does ${ELECTRON_BRAND.shortAppName} have?`, answer: `${ELECTRON_BRAND.shortAppName} offers 5 quick action buttons, screenshot analysis, real-time transcription, and comprehensive meeting notes.` },
