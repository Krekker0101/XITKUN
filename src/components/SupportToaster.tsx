...
export const SupportToaster: React.FC<SupportToasterProps> = ({ className }) => {
    ...
    if (!hasConfiguredLink(BRAND.supportUrl)) return null;
    ...
    const handleSupport = () => {
        ...
        if (window.electronAPI?.openExternal) {
            window.electronAPI.openExternal(BRAND.supportUrl);
        } else {
            window.open(BRAND.supportUrl, '_blank');
        }
    };
                        ...
                        <div className="pt-[42px] flex flex-col items-center w-full px-[40px]">
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-[14px] leading-[1.6] text-white/60 max-w-[480px] font-medium antialiased">
                                    {BRAND.appName} is maintained by {BRAND.ownerName}.<br />
                                    If it is part of your daily workflow, your support keeps<br />
                                    it moving forward.
                                </p>
                            </div>
                        </div>
